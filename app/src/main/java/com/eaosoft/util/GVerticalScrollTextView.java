...
public class GVerticalScrollTextView extends TextView 
{  
    ...
    public GVerticalScrollTextView(Context context, AttributeSet attrs) 
    {  
        super(context, attrs);          
    }  
      
  
    public GVerticalScrollTextView(Context context) 
    {  
        super(context);          
    }  
