...
public class GWareHouseAdapter extends GBaseAdapter {
    ...
    public View getView(int position, View arg1, ViewGroup arg2) {
        ...
        if (arg1 == null) {
            ...
            holder.lv_goodsTask = (TextView) arg1.findViewById(R.id.lv_goodsTask);
            ...
            holder.lv_goodsTask.setLayoutParams(new LinearLayout.LayoutParams(MainActivity.mSreenWidth * 3 / 4 / 5, ViewGroup.LayoutParams.WRAP_CONTENT));
        ...
        holder.lv_goodsTask.setTag(map);
//        if(position%2==0)
...
//            holder.orderNumber.setBackgroundColor(Color.BLUE);
    ...
    private class viewHolder {
        ...
        public TextView lv_goodsTask = null;
    }
}