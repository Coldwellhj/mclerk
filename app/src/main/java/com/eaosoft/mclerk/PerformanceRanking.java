...
public class PerformanceRanking extends Activity implements View.OnClickListener, GestureDetector.OnGestureListener {

    private WebView wv_performance_ranking;
    ...
    private void initData() {
        ...
        strURL = GSvrChannel.m_strURLopSaleScore + "?token=" + GOperaterInfo.m_strToken + "&callerName=" + GSvrChannel.CALLER_NAME + "&month=" + currentMonth + "&year=" + currentYear;
        wv_performance_ranking.loadUrl(strURL);
    }

    private void initView() {
        wv_performance_ranking = (WebView) findViewById(R.id.wv_performance_ranking);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.bt_allInformation:
                ...
                strURL = GSvrChannel.m_strURLopSaleScore + "?token=" + GOperaterInfo.m_strToken + "&callerName=" + GSvrChannel.CALLER_NAME ;
                wv_performance_ranking.loadUrl(strURL);
                break;
        }
    }
    ...
    private void addGridView() {
        ...
        gridView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                return PerformanceRanking.this.gestureDetector.onTouchEvent(event);
            }
        });
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                strURL = GSvrChannel.m_strURLopSaleScore + "?token=" + GOperaterInfo.m_strToken + "&callerName=" + GSvrChannel.CALLER_NAME + "&month=" + monthNumbers[position] + "&year=" + YearNumbers[position];
                wv_performance_ranking.loadUrl(strURL);
